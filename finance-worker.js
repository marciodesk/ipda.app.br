...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;font-family:Arial,"Helvetica Neue",sans-serif;background:var(--bg);color:var(--ink)}[hidden]{display:none!important}
    ...
    input:focus,select:focus{border-color:var(--blue);box-shadow:0 0 0 3px rgba(21,128,61,.16)}input[readonly]{background:#f0f7f4;color:var(--green);font-weight:800;border-color:#acd7c6}.church-filter{display:grid;grid-template-columns:1fr;gap:8px}.church-filter input{height:40px;font-size:.95rem;background:#f7fcf8}.church-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.full{grid-column:1/-1}.church-list{margin-top:18px;border-top:1px solid var(--line);padding-top:18px}.church-list h3{margin:0 0 10px;font-size:.96rem}.church-chip{display:inline-flex;gap:7px;align-items:center;background:#e8f5eb;border:1px solid #cfe4d4;border-radius:999px;padding:7px 11px;margin:0 7px 7px 0;font-size:.8rem}.church-chip small{color:var(--muted)}
    ...
    .balance-box.negative input{background:#fff4f4;color:var(--red);border-color:#e6afb4}.hint{display:block;color:var(--muted);font-size:.75rem;line-height:1.35;margin-top:6px}.document-field{margin-top:18px}.document-field input{height:auto;padding:11px;background:#f4fbf6}.document-tools{display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin-top:10px}.actions{display:flex;justify-content:flex-end;gap:12px;margin-top:26px}
    ...
    .dash-toolbar{display:flex;align-items:end;justify-content:space-between;gap:16px;margin-bottom:18px}.dash-toolbar label{margin:0}.dash-toolbar input{width:190px;background:#123b28;color:#fff;border-color:#2b6142}.live-state{display:flex;align-items:center;gap:8px;color:var(--muted);font-size:.82rem}.live-dot{width:9px;height:9px;border-radius:50%;background:#18b981;box-shadow:0 0 0 5px #18b98122}.dashboard-overview{display:grid;grid-template-columns:minmax(0,1fr) 340px;gap:18px;align-items:stretch}.market{background:#0b2f1f;border:1px solid #28583c;border-radius:14px;padding:18px;color:#e8f5eb;box-shadow:0 12px 30px #0b2f1f24}.ticker{overflow:hidden;white-space:nowrap;color:#86efac;font-size:.78rem;letter-spacing:.09em;border-bottom:1px solid #2c5d40;padding-bottom:13px;margin-bottom:16px}.market-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.quote{background:#123d29;border:1px solid #28583c;border-radius:10px;padding:15px}.quote small{display:block;color:#a7c6b1;text-transform:uppercase;font-size:.68rem;letter-spacing:.07em}.quote strong{display:block;margin-top:8px;font-size:1.28rem}.quote .up{color:#32d296}.quote .down{color:#ff6577}.closing{margin-top:16px;background:#123d29;border-radius:10px;padding:15px}.closing-head{display:flex;justify-content:space-between;font-size:.83rem}.progress{height:10px;background:#2b5e40;border-radius:99px;overflow:hidden;margin-top:10px}.progress span{display:block;height:100%;background:linear-gradient(90deg,#22a052,#32d296);border-radius:99px;transition:width .4s}.top-income-panel{background:#fff;border:1px solid var(--line);border-radius:8px;padding:17px;box-shadow:0 8px 24px rgba(20,83,45,.08);min-height:376px}.top-income-head span{display:block;color:var(--blue);font-size:.68rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.top-income-head h3{margin:5px 0 3px;color:#173d27;font-size:1.05rem}.top-income-head small{color:var(--muted);font-size:.78rem}.top-income-list{list-style:none;margin:15px 0 0;padding:0;display:flex;flex-direction:column;gap:9px}.top-income-item{display:grid;grid-template-columns:28px minmax(0,1fr) auto;gap:10px;align-items:center;border:1px solid #dcebe0;border-radius:8px;padding:9px;background:#f7fcf8}.top-income-rank{width:28px;height:28px;display:grid;place-items:center;border-radius:50%;background:#123d29;color:#86efac;font-size:.78rem;font-weight:800}.top-income-main{min-width:0}.top-income-main strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#173d27;font-size:.86rem}.top-income-main small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted);font-size:.72rem;margin-top:2px}.top-income-amount{color:var(--green);font-weight:800;font-size:.82rem;white-space:nowrap}.top-income-bar{grid-column:2/4;height:6px;background:#dfeee4;border-radius:99px;overflow:hidden}.top-income-bar span{display:block;height:100%;background:linear-gradient(90deg,#15803d,#32d296);border-radius:99px}.top-income-empty{border:1px dashed #c8dacd;border-radius:8px;padding:24px 12px;color:var(--muted);text-align:center;font-size:.86rem}.status-pill{display:inline-block;border-radius:99px;padding:5px 9px;font-weight:800;font-size:.72rem}.status-pill.closed{background:#dff7ed;color:#087a55}.status-pill.pending{background:#fff0f1;color:#ba2d39}.dashboard-list{margin-top:22px}.dashboard-list h3{margin:0 0 11px}.pulse-time{font-variant-numeric:tabular-nums}.evolution-toolbar{display:grid;grid-template-columns:repeat(4,minmax(160px,1fr)) auto;gap:14px;align-items:end;margin-bottom:16px}.evolution-toolbar label{margin:0}.chart-card{padding:18px}.chart-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-bottom:16px}.chart-metric{border:1px solid #dcebe0;border-radius:8px;background:#f7fcf8;padding:12px}.chart-metric small{display:block;color:var(--muted);font-size:.72rem;text-transform:uppercase;font-weight:800}.chart-metric strong{display:block;margin-top:6px;color:#173d27;font-size:1.12rem}.chart-legend{display:flex;gap:16px;flex-wrap:wrap;margin:0 0 12px;color:var(--muted);font-size:.86rem}.legend-dot{width:10px;height:10px;border-radius:50%;display:inline-block;margin-right:6px}.legend-income{background:#087a55}.legend-transferred{background:#d7a92e}.evolution-chart{width:100%;min-height:320px;border:1px solid #dcebe0;border-radius:8px;background:#fff;overflow:hidden}.evolution-chart svg{display:block;width:100%;height:auto;min-height:320px}.chart-empty{display:grid;place-items:center;min-height:260px;color:var(--muted);border:1px dashed #c8dacd;border-radius:8px;background:#f7fcf8}.registration-deadline{margin-top:12px;padding:14px 16px;border:1px solid #d7a92e;border-radius:9px;background:#fff8df;color:#6f5100;font-size:.88rem;line-height:1.45}.registration-deadline strong{display:block;margin-top:4px;color:#14532d;font-size:1rem}
    @media(max-width:820px){.app-shell{display:block}.sidebar{position:relative;height:auto;padding:18px 12px;overflow:hidden}.side-brand{padding:0 7px 15px}.side-brand span{font-size:1.1rem}.app-nav{flex-direction:row;overflow-x:auto;overflow-y:hidden;margin-top:14px;gap:5px;padding-bottom:8px;scroll-snap-type:x proximity;-webkit-overflow-scrolling:touch}.nav-button{width:auto;flex:0 0 auto;padding:11px 13px;font-size:.8rem;scroll-snap-align:start}.nav-icon{display:none}.content{padding:20px 12px 42px}.grid,.financial,.church-grid,.dashboard-overview,.evolution-toolbar,.chart-summary{grid-template-columns:1fr}.market-grid{grid-template-columns:1fr 1fr}.dash-toolbar{align-items:stretch;flex-direction:column}.top-income-panel{min-height:0}.full{grid-column:auto}form,.card-head{padding:19px}.actions{flex-direction:column-reverse}.actions button{width:100%}}
  </style>
</head>
<body>
  ...
  <aside class="sidebar"><div class="side-brand"><strong>Sistema da Igreja</strong><span>Financeiro</span><small>IPDA \u2022 Administra\xE7\xE3o</small></div><nav class="app-nav" aria-label="Menu principal"><button class="nav-button active" type="button" data-view="dashboard" data-roles="admin,agent"><span class="nav-icon" aria-hidden="true">\u2301</span>Dashboard</button><button class="nav-button" type="button" data-view="evolution" data-roles="admin,agent"><span class="nav-icon" aria-hidden="true">&#8645;</span>Evolu&ccedil;&atilde;o Mensal</button><button class="nav-button" type="button" data-view="churches" data-roles="admin,agent"><span class="nav-icon" aria-hidden="true">\u2302</span>Igrejas</button><button class="nav-button" type="button" data-view="finance" data-roles="admin,agent,member"><span class="nav-icon" aria-hidden="true">\u25A3</span>Relat\xF3rios Financeiros</button><button class="nav-button" type="button" data-view="members" data-roles="admin,agent"><span class="nav-icon" aria-hidden="true">\u25CE</span>Cadastro de Membros</button><button class="nav-button" type="button" data-view="users" data-roles="admin"><span class="nav-icon" aria-hidden="true">\u25C9</span>Usu\xE1rios</button><button class="nav-button" type="button" data-view="password" data-roles="admin,agent,member"><span class="nav-icon" aria-hidden="true">\u2318</span>Minha senha</button></nav><div class="user-panel"><strong id="session-name">\u2014</strong><span id="session-role">\u2014</span><button id="logout-button" type="button">Sair</button></div></aside>
  <main class="content"><div class="content-inner">
    <div class="module-view" id="view-dashboard">
      ...
      <div class="dashboard-overview"><section class="market"><div class="ticker" id="market-ticker">MERCADO FINANCEIRO IPDA \u2022 FECHAMENTO MENSAL \u2022 ATUALIZA\xC7\xC3O EM TEMPO REAL</div><div class="market-grid">
      ...
      </div><div class="closing"><div class="closing-head"><span>Progresso do fechamento</span><strong id="closing-label">0 de 0 igrejas</strong></div><div class="progress"><span id="closing-progress" style="width:0%"></span></div></div></section><aside class="top-income-panel" aria-labelledby="top-income-title"><div class="top-income-head"><span>Top 10</span><h3 id="top-income-title">Saldo consolidado</h3><small id="top-income-subtitle">R$ 0,00 no m\xEAs</small></div><ol class="top-income-list" id="top-income-churches"><li class="top-income-empty">Carregando ranking...</li></ol></aside></div>
    ...
    <div class="module-view" id="view-evolution" hidden>
      <div class="module-title"><h2>Evolu&ccedil;&atilde;o Mensal</h2><p>Compare m&ecirc;s a m&ecirc;s as entradas e a transfer&ecirc;ncia para o pr&oacute;ximo m&ecirc;s.</p></div>
      <section class="card chart-card">
        <div class="evolution-toolbar"><label for="evolution-classification">Classifica&ccedil;&atilde;o<select id="evolution-classification"><option value="">Todas as classifica&ccedil;&otilde;es</option></select></label><label for="evolution-parent">Pertence a<select id="evolution-parent"><option value="">Toda a estrutura</option></select></label><label for="evolution-church">Igreja<select id="evolution-church"><option value="">Todas as igrejas do filtro</option></select></label><label for="evolution-chart-type">Visualiza&ccedil;&atilde;o<select id="evolution-chart-type"><option value="bars">Colunas agrupadas</option><option value="line">Linhas com marcadores</option></select></label><button class="save" id="evolution-refresh" type="button">Atualizar gr&aacute;fico</button></div>
        <div class="chart-summary"><div class="chart-metric"><small>Total de entradas</small><strong id="evolution-income-total">R$ 0,00</strong></div><div class="chart-metric"><small>Total transferido</small><strong id="evolution-transferred-total">R$ 0,00</strong></div><div class="chart-metric"><small>Meses com relat&oacute;rio</small><strong id="evolution-months-total">0</strong></div></div>
        <div class="chart-legend"><span><i class="legend-dot legend-income"></i>Entradas</span><span><i class="legend-dot legend-transferred"></i>Transferido pr&oacute;ximo m&ecirc;s</span></div>
        <div class="evolution-chart" id="evolution-chart"><div class="chart-empty">Carregando gr&aacute;fico...</div></div>
      </section>
      <section class="dashboard-list"><h3>Resumo mensal</h3><div class="table-wrap" id="evolution-table"><div class="empty">Carregando evolu&ccedil;&atilde;o...</div></div></section>
    </div>
    ...
    <section class="card">
      ...
      <form id="church-form">
        ...
        <div class="church-list"><div class="recent-head"><h3>Igrejas cadastradas</h3><span class="hint">Edite ou exclua igrejas cadastradas.</span></div><input id="church-list-filter" type="search" autocomplete="off" placeholder="Filtrar por nome, TOTVS, classifica\xE7\xE3o ou igreja respons\xE1vel" style="margin-bottom:12px;background:#f7fcf8"><div class="table-wrap" id="church-list"><div class="empty">Carregando igrejas\u2026</div></div></div>
      </form>
    </section>
    </div>
    ...
    <section class="card">
      ...
      <form id="financial-form">
        ...
        <div class="grid">
          <div class="church-filter"><label for="church">Nome da igreja</label><input id="church-totvs-filter" inputmode="numeric" autocomplete="off" placeholder="Filtrar por TOTVS"><select id="church" name="church_id" required><option value="">Cadastre ou selecione uma igreja</option></select></div>
        ...
        <div class="document-field"><label for="documents">Inserir imagem*</label><div class="photo-options"><input id="documents" name="documents" type="file" accept="image/jpeg,image/png,image/webp"><input class="photo-input" id="document-camera" type="file" accept="image/jpeg,image/png,image/webp" capture="environment"><label class="photo-button" for="document-camera">Tirar foto</label><span class="photo-name" id="document-camera-name">Nenhuma foto capturada</span></div><div class="document-tools"><button class="table-action danger" id="clear-document" type="button" hidden>Remover anexo</button></div><small class="hint" id="document-hint">Obrigat\xF3rio: anexe uma imagem JPG, PNG ou WEBP, ou tire uma foto pelo celular.</small></div>
        <div class="actions"><button class="clear" type="reset">Limpar</button><button class="clear" id="cancel-report-edit" type="button" hidden>Cancelar edi\xE7\xE3o</button><button class="save" type="submit">Salvar relat\xF3rio</button></div>
        <div class="message" id="message" role="status">Relat\xF3rio e imagem salvos com sucesso.</div>
      </form>
    </section>
    ...
    <div class="module-view" id="view-members" hidden>
      ...
      <section class="recent"><div class="recent-head"><h2>Membros cadastrados</h2></div><input id="member-list-filter" type="search" autocomplete="off" placeholder="Filtrar por nome, igreja, CPF, telefone, fun\xE7\xE3o ou situa\xE7\xE3o" style="margin-bottom:12px;background:#f7fcf8"><div class="table-wrap" id="member-list"><div class="empty">Carregando membros\u2026</div></div></section>
    </div>
  ...
  <script>
    const form=document.querySelector('#financial-form'),churchForm=document.querySelector('#church-form'),churchEditId=document.querySelector('#church-edit-id'),cancelChurchEdit=document.querySelector('#cancel-church-edit'),memberForm=document.querySelector('#member-form'),memberPhotoCamera=document.querySelector('#member-photo-camera'),memberPhotoUpload=document.querySelector('#member-photo-upload'),memberPhotoPreview=document.querySelector('#member-photo-preview'),memberPhotoName=document.querySelector('#member-photo-name'),churchSelect=document.querySelector('#church'),churchTotvsFilter=document.querySelector('#church-totvs-filter'),memberChurchSelect=document.querySelector('#member-church'),memberList=document.querySelector('#member-list'),memberListFilter=document.querySelector('#member-list-filter'),memberMessage=document.querySelector('#member-message'),classificationSelect=document.querySelector('#church-classification'),parentChurchSelect=document.querySelector('#parent-church'),churchList=document.querySelector('#church-list'),churchListFilter=document.querySelector('#church-list-filter'),churchMessage=document.querySelector('#church-message'),income=document.querySelector('#income'),expenses=document.querySelector('#expenses'),tithe=document.querySelector('#tithe'),transferred=document.querySelector('#transferred'),documents=document.querySelector('#documents'),documentCamera=document.querySelector('#document-camera'),documentCameraName=document.querySelector('#document-camera-name'),documentHint=document.querySelector('#document-hint'),clearDocumentButton=document.querySelector('#clear-document'),cancelReportEdit=document.querySelector('#cancel-report-edit'),balance=document.querySelector('#balance'),balanceBox=document.querySelector('#balance-box'),reports=document.querySelector('#reports'),message=document.querySelector('#message'),saveButton=form.querySelector('.save');
    ...
    function allowedViews(){const views=currentUser?.role==='admin'?['dashboard','evolution','churches','finance','members','users','password']:currentUser?.role==='agent'?['dashboard','evolution','churches','finance','members','password']:['finance','password'];return churchRegistrationOpen()?views:views.filter(view=>view!=='churches')}
    ...
    async function loadPublicChurchRequests(){if(!publicChurchRequests||currentUser?.role!=='admin')return;publicChurchRequests.innerHTML='<div class="empty">Carregando solicitações...</div>';try{const items=await authApi('solicitacoes-igrejas');publicChurchRequests.innerHTML=items.length?'<table><thead><tr><th>Ações</th><th>Igreja</th><th>Classificação</th><th>Pertence a</th><th>Cidade/UF</th><th>Endereço</th><th>Enviado em</th></tr></thead><tbody>'+items.map(item=>'<tr><td><button class="table-action" data-public-church-action="approve" data-public-church-id="'+escapeHtml(item.id)+'">Aprovar</button><button class="table-action danger" data-public-church-action="reject" data-public-church-id="'+escapeHtml(item.id)+'">Rejeitar</button></td><td><strong>'+escapeHtml(item.name)+'</strong></td><td>'+escapeHtml(item.classification)+'</td><td>'+escapeHtml(item.parent_name||'—')+'</td><td>'+escapeHtml([item.city,item.state].filter(Boolean).join('/')||'—')+'</td><td>'+escapeHtml(item.address)+'</td><td>'+escapeHtml(new Date(item.created_at).toLocaleString('pt-BR'))+'</td></tr>').join('')+'</tbody></table>':'<div class="empty">Nenhuma solicitação pendente.</div>'}catch(error){publicChurchRequests.innerHTML='<div class="empty">'+escapeHtml(error.message)+'</div>'}}
    publicChurchRequests?.addEventListener('click',async e=>{const button=e.target.closest('[data-public-church-action]');if(!button)return;const action=button.dataset.publicChurchAction,id=button.dataset.publicChurchId;if(action==='reject'&&!confirm('Rejeitar esta solicitação?'))return;button.disabled=true;try{await authApi('solicitacoes-igrejas/'+encodeURIComponent(id)+'/'+action,{method:'POST'});publicChurchRequestsMessage.textContent=action==='approve'?'Igreja aprovada e cadastrada.':'Solicitação rejeitada.';publicChurchRequestsMessage.classList.add('show');await loadPublicChurchRequests();await loadChurches()}catch(error){publicChurchRequestsMessage.textContent=error.message;publicChurchRequestsMessage.classList.add('show')}finally{button.disabled=false}});
    ...
    const dashboardMonth=document.querySelector('#dashboard-month'),dashboardChurches=document.querySelector('#dashboard-churches'),dashboardCsv=document.querySelector('#dashboard-csv'),topIncomeChurches=document.querySelector('#top-income-churches'),topIncomeSubtitle=document.querySelector('#top-income-subtitle');
    const evolutionClassification=document.querySelector('#evolution-classification'),evolutionParent=document.querySelector('#evolution-parent'),evolutionChurch=document.querySelector('#evolution-church'),evolutionChartType=document.querySelector('#evolution-chart-type'),evolutionRefresh=document.querySelector('#evolution-refresh'),evolutionChart=document.querySelector('#evolution-chart'),evolutionTable=document.querySelector('#evolution-table'),evolutionIncomeTotal=document.querySelector('#evolution-income-total'),evolutionTransferredTotal=document.querySelector('#evolution-transferred-total'),evolutionMonthsTotal=document.querySelector('#evolution-months-total');
    dashboardMonth.value=new Date().toISOString().slice(0,7);
    function formatDateTime(value){if(!value)return '-';const raw=String(value),date=new Date(raw.includes('T')?raw:raw.replace(' ','T')+'Z');return Number.isNaN(date.getTime())?raw:date.toLocaleString('pt-BR',{timeZone:'America/Manaus',day:'2-digit',month:'2-digit',year:'numeric',hour:'2-digit',minute:'2-digit'})}
    function renderTopIncome(churches,totalBalance){if(topIncomeSubtitle)topIncomeSubtitle.textContent='R$ '+currency(totalBalance)+' no m\xEAs';if(!topIncomeChurches)return;const top=[...churches].sort((a,b)=>(Number(b.balance)||0)-(Number(a.balance)||0)||String(a.name||'').localeCompare(String(b.name||''),'pt-BR')).slice(0,10);if(!top.length){topIncomeChurches.innerHTML='<li class="top-income-empty">Nenhuma igreja cadastrada.</li>';return}const max=Math.max(...top.map(c=>Math.abs(Number(c.balance)||0)),1);topIncomeChurches.innerHTML=top.map((c,index)=>{const place=[c.city,c.state].filter(Boolean).join('/')||c.classification||'\u2014',balance=Number(c.balance)||0,percent=Math.max(6,Math.round(Math.abs(balance)/max*100));return '<li class="top-income-item"><span class="top-income-rank">'+(index+1)+'</span><div class="top-income-main"><strong>'+escapeHtml(c.name)+'</strong><small>'+escapeHtml(place)+'</small></div><span class="top-income-amount '+(balance<0?'negative':'')+'">R$ '+currency(balance)+'</span><div class="top-income-bar"><span style="width:'+percent+'%"></span></div></li>'}).join('')}
    async function loadDashboard(){const month=dashboardMonth.value;if(!month)return;try{const response=await fetch('/financeiro/api/dashboard?month='+encodeURIComponent(month));if(!response.ok)throw new Error();const data=await response.json(),s=data.summary;document.querySelector('#metric-closed').textContent=s.closed;document.querySelector('#metric-pending').textContent=s.pending;document.querySelector('#metric-income').textContent='R$ '+currency(s.income);document.querySelector('#metric-expenses').textContent='R$ '+currency(s.expenses);const balanceMetric=document.querySelector('#metric-balance');balanceMetric.textContent='R$ '+currency(s.balance);balanceMetric.className=s.balance<0?'down':'up';document.querySelector('#metric-tithe').textContent='R$ '+currency(s.tithe);document.querySelector('#metric-transferred').textContent='R$ '+currency(s.transferred);document.querySelector('#metric-total').textContent=s.total;document.querySelector('#metric-percent').textContent=s.percent+'%';document.querySelector('#closing-label').textContent=s.closed+' de '+s.total+' igrejas';document.querySelector('#closing-progress').style.width=s.percent+'%';document.querySelector('#dashboard-updated').textContent=new Date(data.updated_at).toLocaleTimeString('pt-BR');document.querySelector('#market-ticker').textContent='IPDA '+month.split('-').reverse().join('/')+' \u2022 ENTRADAS R$ '+currency(s.income)+' \u25B2 \u2022 SA\xCDDAS R$ '+currency(s.expenses)+' \u25BC \u2022 SALDO R$ '+currency(s.balance)+' \u2022 '+s.closed+' FECHADAS \u2022 '+s.pending+' PENDENTES';renderTopIncome(data.churches,s.balance);dashboardChurches.innerHTML=data.churches.length?'<table><thead><tr><th>Igreja</th><th>TOTVS</th><th>Classifica\xE7\xE3o</th><th>Cidade</th><th>Situa\xE7\xE3o</th><th>Entradas</th><th>Sa\xEDdas</th><th>Saldo</th><th>\xDAltimo envio</th></tr></thead><tbody>'+data.churches.map(c=>'<tr><td><strong>'+escapeHtml(c.name)+'</strong></td><td>'+escapeHtml(c.totvs_code||'\u2014')+'</td><td>'+escapeHtml(c.classification)+'</td><td>'+escapeHtml([c.city,c.state].filter(Boolean).join('/')||'\u2014')+'</td><td><span class="status-pill '+(c.status==='Fechado'?'closed':'pending')+'">'+c.status+'</span></td><td class="amount positive">R$ '+currency(c.income)+'</td><td class="amount negative">R$ '+currency(c.expenses)+'</td><td class="amount '+(c.balance<0?'negative':'positive')+'">R$ '+currency(c.balance)+'</td><td>'+escapeHtml(formatDateTime(c.last_created_at))+'</td></tr>').join('')+'</tbody></table>':'<div class="empty">Nenhuma igreja cadastrada.</div>'}catch{dashboardChurches.innerHTML='<div class="empty">N\xE3o foi poss\xEDvel atualizar o dashboard.</div>';if(topIncomeSubtitle)topIncomeSubtitle.textContent='R$ 0,00 no m\xEAs';if(topIncomeChurches)topIncomeChurches.innerHTML='<li class="top-income-empty">N\xE3o foi poss\xEDvel atualizar o ranking.</li>'}}
    function renderEvolutionChart(series){if(!evolutionChart)return;if(!series.length){evolutionChart.innerHTML='<div class="chart-empty">Nenhum relatorio encontrado para este filtro.</div>';return}const type=evolutionChartType?.value||'bars',width=920,height=340,padLeft=98,padRight=28,padTop=24,padBottom=62,plotW=width-padLeft-padRight,plotH=height-padTop-padBottom,max=Math.max(...series.flatMap(item=>[Number(item.income)||0,Number(item.transferred)||0]),1),y=v=>padTop+(1-(Number(v)||0)/max)*plotH,grid=[0,.25,.5,.75,1].map(step=>{const value=max*step,yy=y(value);return '<g><line x1="'+padLeft+'" x2="'+(width-padRight)+'" y1="'+yy+'" y2="'+yy+'" stroke="#e4eee7"></line><text x="'+(padLeft-10)+'" y="'+(yy+4)+'" text-anchor="end" font-size="12" fill="#607567">R$ '+currency(value).replace(',00','')+'</text></g>'}).join(''),axis='<line x1="'+padLeft+'" x2="'+(width-padRight)+'" y1="'+(height-padBottom)+'" y2="'+(height-padBottom)+'" stroke="#c8dacd"></line>',labelX=i=>series.length===1?padLeft+plotW/2:padLeft+i*(plotW/(series.length-1)),barX=i=>padLeft+(i+.5)*(plotW/series.length),labels=series.map((item,i)=>'<text x="'+(type==='bars'?barX(i):labelX(i))+'" y="'+(height-22)+'" text-anchor="middle" font-size="12" fill="#607567">'+escapeHtml(item.label)+'</text>').join('');if(type==='line'){const line=(field,color)=>'<polyline fill="none" stroke="'+color+'" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" points="'+series.map((item,i)=>labelX(i)+','+y(item[field])).join(' ')+'"></polyline>',dots=(field,color)=>series.map((item,i)=>'<circle cx="'+labelX(i)+'" cy="'+y(item[field])+'" r="6" fill="'+color+'"><title>'+escapeHtml(item.label)+' - R$ '+currency(item[field])+'</title></circle>').join('');evolutionChart.innerHTML='<svg viewBox="0 0 '+width+' '+height+'" role="img" aria-label="Evolucao mensal de entradas e transferido"><rect width="'+width+'" height="'+height+'" fill="#fff"></rect>'+grid+axis+line('income','#087a55')+line('transferred','#d7a92e')+dots('income','#087a55')+dots('transferred','#d7a92e')+labels+'</svg>';return}const slot=plotW/series.length,groupW=Math.min(88,slot*.62),barW=Math.max(18,groupW/2-5),bars=series.map((item,i)=>{const cx=barX(i),incomeY=y(item.income),transferredY=y(item.transferred),base=height-padBottom,incomeH=Math.max(2,base-incomeY),transferredH=Math.max(2,base-transferredY);return '<rect x="'+(cx-barW-3)+'" y="'+(base-incomeH)+'" width="'+barW+'" height="'+incomeH+'" rx="4" fill="#087a55"><title>'+escapeHtml(item.label)+' - Entradas R$ '+currency(item.income)+'</title></rect><rect x="'+(cx+3)+'" y="'+(base-transferredH)+'" width="'+barW+'" height="'+transferredH+'" rx="4" fill="#d7a92e"><title>'+escapeHtml(item.label)+' - Transferido R$ '+currency(item.transferred)+'</title></rect>'}).join('');evolutionChart.innerHTML='<svg viewBox="0 0 '+width+' '+height+'" role="img" aria-label="Evolucao mensal de entradas e transferido em colunas agrupadas"><rect width="'+width+'" height="'+height+'" fill="#fff"></rect>'+grid+axis+bars+labels+'</svg>'}
    function evolutionDescendants(churches,parentId){const ids=new Set(parentId?[parentId]:[]);let changed=true;while(changed){changed=false;churches.forEach(c=>{if(c.parent_church_id&&ids.has(c.parent_church_id)&&!ids.has(c.id)){ids.add(c.id);changed=true}})}return ids}
    function evolutionFilteredChurches(churches){const classification=evolutionClassification?.value||'',parentId=evolutionParent?.value||'',ids=evolutionDescendants(churches,parentId);return churches.filter(c=>(!classification||c.classification===classification)&&(!parentId||ids.has(c.id)))}
    function renderEvolution(data){if(!evolutionChurch)return;const selectedClassification=evolutionClassification.value,selectedParent=evolutionParent.value,selectedChurch=evolutionChurch.value,churches=data.churches||[],classifications=[...new Set(churches.map(c=>c.classification).filter(Boolean))].sort((a,b)=>a.localeCompare(b,'pt-BR'));evolutionClassification.innerHTML='<option value="">Todas as classificacoes</option>'+classifications.map(item=>'<option value="'+escapeHtml(item)+'">'+escapeHtml(item)+'</option>').join('');if([...evolutionClassification.options].some(option=>option.value===selectedClassification))evolutionClassification.value=selectedClassification;evolutionParent.innerHTML='<option value="">Toda a estrutura</option>'+churches.map(c=>'<option value="'+escapeHtml(c.id)+'">'+escapeHtml(c.name)+(c.totvs_code?' | TOTVS '+escapeHtml(c.totvs_code):'')+'</option>').join('');if([...evolutionParent.options].some(option=>option.value===selectedParent))evolutionParent.value=selectedParent;const filtered=evolutionFilteredChurches(churches);evolutionChurch.innerHTML='<option value="">Todas as igrejas do filtro</option>'+filtered.map(c=>'<option value="'+escapeHtml(c.id)+'">'+escapeHtml(c.name)+(c.totvs_code?' | TOTVS '+escapeHtml(c.totvs_code):'')+' - '+escapeHtml(c.classification)+'</option>').join('');if([...evolutionChurch.options].some(option=>option.value===selectedChurch))evolutionChurch.value=selectedChurch;const series=data.series||[],incomeTotal=series.reduce((sum,item)=>sum+(Number(item.income)||0),0),transferredTotal=series.reduce((sum,item)=>sum+(Number(item.transferred)||0),0);evolutionIncomeTotal.textContent='R$ '+currency(incomeTotal);evolutionTransferredTotal.textContent='R$ '+currency(transferredTotal);evolutionMonthsTotal.textContent=series.length;renderEvolutionChart(series);evolutionTable.innerHTML=series.length?'<table><thead><tr><th>Mes</th><th>Entradas</th><th>Transferido proximo mes</th></tr></thead><tbody>'+series.map(item=>'<tr><td><strong>'+escapeHtml(item.label)+'</strong></td><td class="amount positive">R$ '+currency(item.income)+'</td><td class="amount">R$ '+currency(item.transferred)+'</td></tr>').join('')+'</tbody></table>':'<div class="empty">Nenhum relatorio encontrado para este filtro.</div>'}
    async function loadEvolution(){if(!evolutionChart)return;evolutionChart.innerHTML='<div class="chart-empty">Carregando grafico...</div>';try{const params=new URLSearchParams();if(evolutionClassification?.value)params.set('classification',evolutionClassification.value);if(evolutionParent?.value)params.set('parent_church_id',evolutionParent.value);if(evolutionChurch?.value)params.set('church_id',evolutionChurch.value);const query=params.toString()?'?'+params.toString():'',response=await fetch('/financeiro/api/evolucao'+query),data=await response.json();if(!response.ok)throw new Error(data.error||'Nao foi possivel carregar a evolucao.');renderEvolution(data)}catch(error){evolutionChart.innerHTML='<div class="chart-empty">'+escapeHtml(error.message)+'</div>';evolutionTable.innerHTML='<div class="empty">'+escapeHtml(error.message)+'</div>'}}
    evolutionClassification?.addEventListener('change',()=>{evolutionChurch.value='';loadEvolution()});evolutionParent?.addEventListener('change',()=>{evolutionChurch.value='';loadEvolution()});evolutionChurch?.addEventListener('change',loadEvolution);evolutionChartType?.addEventListener('change',loadEvolution);evolutionRefresh?.addEventListener('click',loadEvolution);
    ...
    async function render(){reports.innerHTML='<div class="empty">Carregando relat\xF3rios\u2026</div>';try{const data=await readReports();reportsCache=data;if(!data.length){reports.innerHTML='<div class="empty">Nenhum relat\xF3rio salvo.</div>';return}reports.innerHTML='<table><thead><tr><th>A\xE7\xF5es</th><th>Data</th><th>Enviado em</th><th>Igreja</th><th>TOTVS</th><th>Respons\xE1vel</th><th>Membros</th><th>Entradas</th><th>Sa\xEDdas</th><th>Saldo</th><th>D\xEDzimo</th><th>Transfer\xEAncia para o pr\xF3ximo m\xEAs</th><th>Documentos</th><th>Relat\xF3rio</th></tr></thead><tbody>'+data.map(r=>'<tr><td><button class="table-action" type="button" data-edit-report="'+escapeHtml(r.id)+'">Editar</button><button class="table-action danger" type="button" data-delete-report="'+escapeHtml(r.id)+'">Excluir</button></td><td>'+escapeHtml(r.report_date)+'</td><td>'+escapeHtml(formatDateTime(r.created_at))+'</td><td>'+escapeHtml(r.church)+'</td><td>'+escapeHtml(r.totvs_code||'\u2014')+'</td><td>'+escapeHtml(r.responsible)+'</td><td>'+r.members+'</td><td class="amount">R$ '+currency(r.income)+'</td><td class="amount">R$ '+currency(r.expenses)+'</td><td class="amount '+(r.balance<0?'negative':'positive')+'">R$ '+currency(r.balance)+'</td><td class="amount">R$ '+currency(r.tithe||0)+'</td><td class="amount">R$ '+currency(r.transferred||0)+'</td><td>'+(r.documents.length?r.documents.map(d=>'<a href="/financeiro/documentos/'+encodeURIComponent(d.id)+'" target="_blank">'+escapeHtml(d.filename)+'</a>').join('<br>'):'\u2014')+'</td><td><a class="button-link" href="/financeiro/relatorios/'+encodeURIComponent(r.id)+'/imprimir" target="_blank">Exportar PDF</a></td></tr>').join('')+'</tbody></table>'}catch(error){reports.innerHTML='<div class="empty">'+escapeHtml(error.message)+'</div>'}}
    ...
    function filterChurchSelectByTotvs(){const filter=String(churchTotvsFilter?.value||'').trim().toLowerCase();let visible=0;[...churchSelect.options].forEach((option,index)=>{if(index===0){option.hidden=false;return}const text=(option.dataset.totvs+' '+option.textContent).toLowerCase(),show=!filter||text.includes(filter);option.hidden=!show;if(show)visible++});if(filter&&churchSelect.selectedOptions[0]?.hidden)churchSelect.value='';churchSelect.options[0].textContent=filter&&!visible?'Nenhuma igreja encontrada':'Selecione uma igreja'}
    function resetChurchTotvsFilter(){if(churchTotvsFilter)churchTotvsFilter.value='';filterChurchSelectByTotvs();churchSelect.value='';churchSelect.blur()}
    churchTotvsFilter?.addEventListener('input',filterChurchSelectByTotvs);
    function applyChurchListFilter(){const filter=String(churchListFilter?.value||'').trim().toLowerCase(),rows=[...churchList.querySelectorAll('tbody tr')],matched=new Set(),visibleIds=new Set();if(filter){churchesCache.forEach(c=>{const text=[c.name,c.totvs_code,c.classification,c.parent_name,c.address,c.neighborhood,c.city,c.state,c.postal_code,c.address_number,c.reference_point].join(' ').toLowerCase();if(text.includes(filter))matched.add(c.id)});let changed=true;matched.forEach(id=>visibleIds.add(id));while(changed){changed=false;churchesCache.forEach(c=>{if(c.parent_church_id&&visibleIds.has(c.parent_church_id)&&!visibleIds.has(c.id)){visibleIds.add(c.id);changed=true}})}}let visible=0;rows.forEach(row=>{const show=!filter||visibleIds.has(row.dataset.churchId)||row.textContent.toLowerCase().includes(filter);row.hidden=!show;if(show)visible++});const empty=churchList.querySelector('[data-filter-empty]');if(empty)empty.hidden=!filter||visible>0}
    churchListFilter?.addEventListener('input',applyChurchListFilter);
    async function loadChurches(){try{const response=await fetch('/financeiro/api/igrejas');if(!response.ok)throw new Error();const data=await response.json();churchesCache=data;const options=data.map(c=>'<option value="'+c.id+'" data-name="'+escapeHtml(c.name)+'" data-totvs="'+escapeHtml(c.totvs_code||'')+'">'+escapeHtml(c.name)+' \u2014 '+escapeHtml(c.classification)+(c.totvs_code?' | TOTVS '+escapeHtml(c.totvs_code):'')+'</option>').join('');churchSelect.innerHTML='<option value="">'+(data.length?'Selecione uma igreja':'Cadastre uma igreja primeiro')+'</option>'+options;filterChurchSelectByTotvs();memberChurchSelect.innerHTML='<option value="">'+(data.length?'Selecione uma igreja':'Cadastre uma igreja primeiro')+'</option>'+options;parentChurchSelect.innerHTML='<option value="">Selecione uma igreja j\xE1 cadastrada</option>'+options;updateParentRequirement();churchList.innerHTML=data.length?'<table><thead><tr><th>A\xE7\xF5es</th><th>Nome</th><th>TOTVS</th><th>Classifica\xE7\xE3o</th><th>Pertence a</th><th>Endere\xE7o</th><th>Bairro</th><th>Cidade/Estado</th><th>CEP</th><th>N\xFAmero</th><th>Ponto de refer\xEAncia</th></tr></thead><tbody>'+data.map(c=>'<tr data-church-id="'+escapeHtml(c.id)+'"><td><button class="table-action" type="button" data-edit-church="'+c.id+'">Editar</button><button class="table-action danger" type="button" data-delete-church="'+c.id+'">Excluir</button></td><td><strong>'+escapeHtml(c.name)+'</strong></td><td>'+escapeHtml(c.totvs_code||'\u2014')+'</td><td>'+escapeHtml(c.classification)+'</td><td>'+escapeHtml(c.parent_name||'\u2014')+'</td><td>'+escapeHtml(c.address)+'</td><td>'+escapeHtml(c.neighborhood||'\u2014')+'</td><td>'+escapeHtml([c.city,c.state].filter(Boolean).join('/')||'\u2014')+'</td><td>'+escapeHtml(c.postal_code||'\u2014')+'</td><td>'+escapeHtml(c.address_number||'\u2014')+'</td><td>'+escapeHtml(c.reference_point||'\u2014')+'</td></tr>').join('')+'</tbody></table><div class="empty" data-filter-empty hidden>Nenhuma igreja encontrada.</div>':'<div class="empty">Nenhuma igreja cadastrada.</div>';applyChurchListFilter()}catch{churchList.innerHTML='<div class="empty">N\xE3o foi poss\xEDvel carregar as igrejas.</div>'}}
    ...
    function updateDocumentCameraName(){const hasUpload=Boolean(documents?.files?.length);if(documentCameraName)documentCameraName.textContent=selectedDocumentPhotos.length?'Foto capturada':hasUpload?'Imagem selecionada':'Nenhuma foto capturada';if(clearDocumentButton)clearDocumentButton.hidden=!(hasUpload||selectedDocumentPhotos.length)}
    function clearDocumentPhotos(){selectedDocumentPhotos=[];if(documents)documents.value='';if(documentCamera)documentCamera.value='';updateDocumentCameraName()}
    clearDocumentButton?.addEventListener('click',clearDocumentPhotos);
    documents?.addEventListener('change',()=>{if(documents.files.length)selectedDocumentPhotos=[];updateDocumentCameraName()});
    documentCamera?.addEventListener('change',()=>{selectedDocumentPhotos=[...documentCamera.files].slice(0,1);if(documents)documents.value='';documentCamera.value='';updateDocumentCameraName()});
    ...
    function clearReportEditing(){editingReportId='';editingReportDate='';documents.required=false;if(documentHint)documentHint.textContent='Obrigat\xF3rio: anexe uma imagem JPG, PNG ou WEBP, ou tire uma foto pelo celular.';if(cancelReportEdit)cancelReportEdit.hidden=true;saveButton.textContent='Salvar relat\xF3rio'}
    function editReport(id){if(currentUser?.role!=='admin')return;const report=reportsCache.find(item=>item.id===id);if(!report)return;editingReportId=id;editingReportDate=report.report_date||'';churchSelect.value=report.church_id||'';form.responsible.value=report.responsible||'';form.members.value=Number(report.members)||0;income.value=currency(report.income);expenses.value=currency(report.expenses);tithe.value=currency(report.tithe||0);transferred.value=currency(report.transferred||0);documents.required=false;clearDocumentPhotos();if(documentHint)documentHint.textContent='Anexo atual ser\xE1 mantido. Escolha outra imagem ou tire uma foto para substituir.';if(cancelReportEdit)cancelReportEdit.hidden=false;saveButton.textContent='Atualizar relat\xF3rio';updateBalance();form.scrollIntoView({behavior:'smooth',block:'start'})}
    cancelReportEdit?.addEventListener('click',()=>{form.reset();clearReportEditing();clearDocumentPhotos();resetChurchTotvsFilter();updateBalance();message.classList.remove('show')});
    ...
    form.addEventListener('reset',()=>setTimeout(()=>{clearReportEditing();clearDocumentPhotos();resetChurchTotvsFilter();updateBalance();message.classList.remove('show')},0));
    form.addEventListener('submit',async e=>{e.preventDefault();saveButton.disabled=true;saveButton.textContent='Salvando\u2026';message.classList.remove('show');message.textContent=editingReportId?'Relat\xF3rio atualizado com sucesso.':'Relat\xF3rio e imagem salvos com sucesso.';message.style.background='';message.style.color='';try{const selected=churchSelect.options[churchSelect.selectedIndex],reportFiles=[...documents.files,...selectedDocumentPhotos];if(!editingReportId&&!reportFiles.length)throw new Error('Anexe uma imagem ou tire uma foto para salvar o relat\xF3rio.');if(reportFiles.length>1)throw new Error('Envie apenas uma imagem por relat\xF3rio.');const payload={report_date:editingReportDate||new Date().toLocaleDateString('pt-BR'),church_id:churchSelect.value,church:selected?.dataset.name||'',responsible:form.responsible.value.trim(),members:Number(form.members.value),income:number(income.value),expenses:number(expenses.value),balance:updateBalance(),tithe:number(tithe.value),transferred:number(transferred.value)};const body=new FormData();body.append('report',JSON.stringify(payload));reportFiles.forEach(file=>body.append('documents',file));const response=await fetch(editingReportId?'/financeiro/api/relatorios/'+encodeURIComponent(editingReportId):'/financeiro/api/relatorios',{method:editingReportId?'PUT':'POST',body});const result=await response.json();if(!response.ok)throw new Error(result.error||'N\xE3o foi poss\xEDvel salvar o relat\xF3rio.');form.reset();clearDocumentPhotos();if(currentUser?.role==='member')form.responsible.value=currentUser.name;updateBalance();message.classList.add('show');if(currentUser?.role==='admin')await render();setTimeout(()=>message.classList.remove('show'),4000)}catch(error){message.textContent=error.message;message.style.background='#fff0f0';message.style.color='#9f1d2a';message.classList.add('show')}finally{saveButton.disabled=false;saveButton.textContent=editingReportId?'Atualizar relat\xF3rio':'Salvar relat\xF3rio'}});
...
async function listReports(env) {
  ...
  const reports = (await env.DB.prepare(`SELECT fr.*, c.totvs_code
    ...
    ORDER BY fr.created_at DESC`).all()).results || [];
...
async function dashboardData(month, env) {
  ...
  for (const report of reports) {
    ...
    const current = totalsByChurch.get(report.church_id) || { income: 0, expenses: 0, balance: 0, tithe: 0, transferred: 0, last_report: report.report_date, last_created_at: report.created_at };
  ...
  const rows = churches.map((church) => {
    ...
    return { ...church, status: totals ? "Fechado" : "Pendente", income: totals?.income || 0, expenses: totals?.expenses || 0, balance: totals?.balance || 0, tithe: totals?.tithe || 0, transferred: totals?.transferred || 0, last_report: totals?.last_report || null, last_created_at: totals?.last_created_at || null };
  }).sort((a, b) => {
    if (a.status !== b.status) return a.status === "Fechado" ? -1 : 1;
    if (a.status === "Fechado") return String(b.last_created_at || "").localeCompare(String(a.last_created_at || "")) || String(a.name || "").localeCompare(String(b.name || ""), "pt-BR");
...
async function evolutionData(filters, env) {
  await ensureTransferredColumn(env);
  const churches = (await env.DB.prepare(`SELECT c.id, c.name, c.totvs_code, c.classification, c.parent_church_id, p.name AS parent_name
    FROM churches c
    LEFT JOIN churches p ON p.id = c.parent_church_id
    ORDER BY c.name COLLATE NOCASE`).all()).results || [];
  const selectedChurchId = String(filters?.churchId || "").trim();
  const selectedParentId = String(filters?.parentChurchId || "").trim();
  const selectedClassification = String(filters?.classification || "").trim();
  if (selectedChurchId && !churches.some((church) => church.id === selectedChurchId)) return null;
  if (selectedParentId && !churches.some((church) => church.id === selectedParentId)) return null;
  const descendantIds = new Set();
  if (selectedParentId) {
    descendantIds.add(selectedParentId);
    let changed = true;
    while (changed) {
      changed = false;
      for (const church of churches) {
        if (church.parent_church_id && descendantIds.has(church.parent_church_id) && !descendantIds.has(church.id)) {
          descendantIds.add(church.id);
          changed = true;
        }
      }
    }
  }
  const hasFilters = Boolean(selectedClassification || selectedParentId || selectedChurchId);
  const filteredChurchIds = churches.filter((church) => {
    if (selectedClassification && church.classification !== selectedClassification) return false;
    if (selectedParentId && !descendantIds.has(church.id)) return false;
    if (selectedChurchId && church.id !== selectedChurchId) return false;
    return true;
  }).map((church) => church.id);
  if (hasFilters && !filteredChurchIds.length) {
    return { church_id: selectedChurchId, parent_church_id: selectedParentId, classification: selectedClassification, churches, series: [] };
  }
  const placeholders = hasFilters ? filteredChurchIds.map(() => "?").join(",") : "";
  const sql = `SELECT substr(report_date, 7, 4) || '-' || substr(report_date, 4, 2) AS report_month,
      SUM(income) AS income,
      SUM(transferred) AS transferred
    FROM financial_reports
    WHERE length(report_date) >= 10 ${hasFilters ? `AND church_id IN (${placeholders})` : ""}
    GROUP BY report_month
    ORDER BY report_month ASC`;
  const query = env.DB.prepare(sql);
  const rows = (hasFilters ? await query.bind(...filteredChurchIds).all() : await query.all()).results || [];
  const series = rows.filter((row) => /^\d{4}-\d{2}$/.test(String(row.report_month || ""))).map((row) => ({
    month: row.report_month,
    label: String(row.report_month).slice(5, 7) + "/" + String(row.report_month).slice(0, 4),
    income: Number(row.income) || 0,
    transferred: Number(row.transferred) || 0
  }));
  return { church_id: selectedChurchId, parent_church_id: selectedParentId, classification: selectedClassification, churches, series };
}
__name(evolutionData, "evolutionData");
function dashboardCsv(data) {
  ...
  const rows = data.churches.map((church) => [
    ...
    church.last_created_at || church.last_report || ""
  ]);
...
const PUBLIC_REPORTS_START = { year: 2026, month: 8 };
const PUBLIC_REPORTS_TIME_ZONE = "America/Manaus";
function manaDateParts(date = /* @__PURE__ */ new Date()) {
  const parts = new Intl.DateTimeFormat("en-CA", { timeZone: PUBLIC_REPORTS_TIME_ZONE, year: "numeric", month: "2-digit", day: "2-digit" }).formatToParts(date);
  const value = (type) => Number(parts.find((part) => part.type === type)?.value || 0);
  return { year: value("year"), month: value("month"), day: value("day") };
}
__name(manaDateParts, "manaDateParts");
function publicReportsWindow(date = /* @__PURE__ */ new Date()) {
  const current = manaDateParts(date);
  const started = current.year > PUBLIC_REPORTS_START.year || current.year === PUBLIC_REPORTS_START.year && current.month >= PUBLIC_REPORTS_START.month;
  const open = started && current.day >= 1 && current.day <= 8;
  const monthLabel = new Intl.DateTimeFormat("pt-BR", { timeZone: PUBLIC_REPORTS_TIME_ZONE, month: "long", year: "numeric" }).format(date);
  return { ...current, open, month: `${current.year}-${String(current.month).padStart(2, "0")}`, reportDate: `${String(current.day).padStart(2, "0")}/${String(current.month).padStart(2, "0")}/${current.year}`, monthLabel };
}
__name(publicReportsWindow, "publicReportsWindow");
function publicFinancialReportPage() {
  const windowState = publicReportsWindow();
  if (!windowState.open) return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>Envio fechado | IPDA</title><style>body{font-family:Arial,sans-serif;background:#f0f7f2;color:#243b2e;display:grid;place-items:center;min-height:100vh;margin:0}.card{width:min(560px,calc(100% - 28px));background:#fff;border:1px solid #d5e5d9;border-radius:10px;padding:30px;text-align:center;box-shadow:0 8px 24px #14532d14}.card h1{margin:0 0 8px;color:#14532d}.card p{margin:8px 0;color:#607567;line-height:1.45}</style></head><body><main class="card"><h1>Envio de relatórios fechado</h1><p>O link público abre todo mês do dia 1 ao dia 8, a partir de 01/08/2026.</p><p>Nenhum valor financeiro fica disponível nesta página.</p></main></body></html>`;
  return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>Relatório Financeiro | IPDA</title><style>
  :root{--navy:#14532d;--green:#087a55;--red:#ba2d39;--ink:#243b2e;--muted:#607567;--line:#d5e5d9;--bg:#f0f7f2}
  *{box-sizing:border-box}body{margin:0;font-family:Arial,"Helvetica Neue",sans-serif;background:var(--bg);color:var(--ink)}.wrap{width:min(980px,calc(100% - 24px));margin:24px auto 42px}.head{margin-bottom:18px}.head h1{margin:0 0 6px;color:var(--navy);font-size:1.55rem}.head p{margin:0;color:var(--muted)}.notice{margin-top:14px;padding:12px 14px;border:1px solid #d7a92e;border-radius:8px;background:#fff8df;color:#6f5100;font-size:.9rem}.card{background:#fff;border:1px solid var(--line);border-radius:10px;box-shadow:0 8px 24px #14532d14;overflow:hidden}.card-head{padding:21px 22px;border-bottom:1px solid var(--line)}.card-head h2{margin:0 0 5px;font-size:1.08rem}.card-head p{margin:0;color:var(--muted);font-size:.9rem}form{padding:22px}.section-title{font-size:.78rem;color:#15803d;text-transform:uppercase;letter-spacing:.08em;font-weight:800;margin:0 0 14px}.grid{display:grid;grid-template-columns:2fr 2fr 1fr;gap:15px}.financial{grid-template-columns:repeat(4,1fr)}label{display:block;font-size:.85rem;font-weight:700;margin-bottom:7px}input,select{width:100%;height:46px;border:1px solid #c8dacd;border-radius:8px;padding:0 13px;font-size:1rem;color:var(--ink);background:#fff;outline:none}input:focus,select:focus{border-color:#15803d;box-shadow:0 0 0 3px rgba(21,128,61,.16)}input[readonly]{background:#f0f7f4;color:var(--green);font-weight:800}.money{position:relative}.money>span{position:absolute;left:13px;top:39px;color:var(--muted);font-size:.9rem;line-height:1}.money input{padding-left:42px}.balance-box.negative input{background:#fff4f4;color:var(--red);border-color:#e6afb4}.divider{height:1px;background:var(--line);margin:24px 0}.hint{display:block;color:var(--muted);font-size:.75rem;line-height:1.35;margin-top:6px}.document-field{margin-top:18px}.document-field input{height:auto;padding:11px;background:#f4fbf6}.photo-input{position:absolute;width:1px!important;height:1px!important;opacity:0;pointer-events:none}.photo-options{display:flex;flex-wrap:wrap;gap:10px;align-items:center}.photo-button{display:inline-flex;align-items:center;margin:0;padding:11px 15px;border-radius:8px;background:var(--navy);color:#fff;font-size:.86rem;font-weight:800;cursor:pointer}.photo-name{width:100%;color:var(--muted);font-size:.78rem}.actions{display:flex;justify-content:flex-end;gap:12px;margin-top:26px}button{border:0;border-radius:8px;padding:12px 20px;font-weight:800;font-size:.93rem;cursor:pointer}.clear{background:#e6f2e9;color:var(--navy)}.save{background:var(--navy);color:#fff}.message{display:none;margin-top:18px;padding:12px 14px;border-radius:8px;background:#eaf7f1;color:#086347;font-size:.9rem;font-weight:700}.message.show{display:block}.message.error{background:#fff0f0;color:#9f1d2a}@media(max-width:760px){.grid,.financial{grid-template-columns:1fr}form,.card-head{padding:18px}.actions{flex-direction:column-reverse}.actions button{width:100%}}
  </style></head><body><main class="wrap"><header class="head"><h1>Relatório Financeiro</h1><p>Igreja Pentecostal Deus é Amor</p><div class="notice">Envio público aberto para ${safeText(windowState.monthLabel)} até o dia 8. Esta página é apenas para preenchimento e não exibe relatórios, documentos ou valores já enviados.</div></header><section class="card"><div class="card-head"><h2>Novo relatório financeiro</h2><p>Preencha os dados da igreja e anexe uma imagem do comprovante do período.</p></div><form id="financial-form">
  <p class="section-title">Identificação</p><div class="grid"><div><label for="church">Nome da igreja</label><input id="church-totvs-filter" inputmode="numeric" autocomplete="off" placeholder="Filtrar por TOTVS" style="height:40px;margin-bottom:8px;background:#f7fcf8"><select id="church" name="church_id" required><option value="">Carregando igrejas...</option></select></div><div><label for="responsible">Responsável pelo relatório</label><input id="responsible" name="responsible" autocomplete="name" required placeholder="Nome completo"></div><div><label for="members">Membros ativos</label><input id="members" name="members" type="number" min="0" step="1" required placeholder="0"></div></div>
  <div class="divider"></div><p class="section-title">Movimentação</p><div class="grid financial"><div class="money"><label for="income">Entradas</label><span>R$</span><input id="income" name="income" inputmode="decimal" required placeholder="0,00"></div><div class="money"><label for="expenses">Saídas</label><span>R$</span><input id="expenses" name="expenses" inputmode="decimal" required placeholder="0,00"></div><div class="money balance-box" id="balance-box"><label for="balance">Saldo (entradas - saídas)</label><span>R$</span><input id="balance" name="balance" readonly value="0,00" aria-live="polite"></div><div class="money"><label for="tithe">Dízimo</label><span>R$</span><input id="tithe" name="tithe" inputmode="decimal" placeholder="0,00"><small class="hint">Valor informativo; não entra no cálculo do saldo.</small></div><div class="money"><label for="transferred">Transferência para o próximo mês</label><span>R$</span><input id="transferred" name="transferred" inputmode="decimal" placeholder="0,00"><small class="hint">Valor reservado para despesas básicas da igreja no próximo mês. Não altera o cálculo do saldo.</small></div></div>
  <div class="document-field"><label for="documents">Inserir imagem*</label><div class="photo-options"><input id="documents" name="documents" type="file" accept="image/jpeg,image/png,image/webp"><input class="photo-input" id="document-camera" type="file" accept="image/jpeg,image/png,image/webp" capture="environment"><label class="photo-button" for="document-camera">Tirar foto</label><span class="photo-name" id="document-camera-name">Nenhuma foto capturada</span></div><small class="hint">Obrigatório: anexe uma imagem JPG, PNG ou WEBP, ou tire uma foto pelo celular.</small></div><div class="actions"><button class="clear" type="reset">Limpar</button><button class="save" type="submit">Salvar relatório</button></div><div class="message" id="message" role="status"></div></form></section></main><script>
  const form=document.querySelector('#financial-form'),church=document.querySelector('#church'),churchTotvsFilter=document.querySelector('#church-totvs-filter'),income=document.querySelector('#income'),expenses=document.querySelector('#expenses'),tithe=document.querySelector('#tithe'),transferred=document.querySelector('#transferred'),balance=document.querySelector('#balance'),balanceBox=document.querySelector('#balance-box'),documents=document.querySelector('#documents'),documentCamera=document.querySelector('#document-camera'),documentCameraName=document.querySelector('#document-camera-name'),message=document.querySelector('#message');let selectedDocumentPhotos=[],churchData=[];
  function number(value){let v=String(value||'').trim().replace(/[^0-9,.-]/g,'');if(v.includes(','))v=v.replace(/\\./g,'').replace(',','.');return Number(v)||0}function currency(value){return Number(value).toLocaleString('pt-BR',{minimumFractionDigits:2,maximumFractionDigits:2})}function updateBalance(){const value=number(income.value)-number(expenses.value);balance.value=currency(value);balanceBox.classList.toggle('negative',value<0);return value}function clearMsg(){message.className='message';message.textContent=''}function updateDocumentCameraName(){documentCameraName.textContent=selectedDocumentPhotos.length?'Foto capturada':'Nenhuma foto capturada'}function clearDocumentPhotos(){selectedDocumentPhotos=[];updateDocumentCameraName()}documents.addEventListener('change',()=>{if(documents.files.length)clearDocumentPhotos()});documentCamera.addEventListener('change',()=>{selectedDocumentPhotos=[...documentCamera.files].slice(0,1);documents.value='';documentCamera.value='';updateDocumentCameraName()});
  function esc(s){return String(s||'').replace(/[&<>"]/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;'}[m]))}function renderChurchOptions(){const filter=String(churchTotvsFilter.value||'').trim().toLowerCase(),items=churchData.filter(c=>!filter||String(c.totvs_code||'').toLowerCase().includes(filter)||String(c.name||'').toLowerCase().includes(filter));church.innerHTML='<option value="">'+(filter&&!items.length?'Nenhuma igreja encontrada':'Selecione uma igreja')+'</option>'+items.map(c=>'<option value="'+esc(c.id)+'" data-name="'+esc(c.name)+'">'+esc(c.name)+(c.totvs_code?' | TOTVS '+esc(c.totvs_code):'')+'</option>').join('')}async function loadChurches(){try{const response=await fetch('/financeiro/api/publico/relatorio/igrejas');const data=await response.json();if(!response.ok)throw new Error(data.error||'Não foi possível carregar as igrejas.');churchData=data;renderChurchOptions()}catch(error){church.innerHTML='<option value="">Link indisponível</option>';message.textContent=error.message;message.className='message error show'}}
  churchTotvsFilter.addEventListener('input',renderChurchOptions);
  [income,expenses].forEach(el=>el.addEventListener('input',updateBalance));[income,expenses,tithe,transferred].forEach(el=>el.addEventListener('blur',()=>{el.value=currency(number(el.value));updateBalance()}));form.addEventListener('reset',()=>setTimeout(()=>{clearDocumentPhotos();churchTotvsFilter.value='';renderChurchOptions();church.value='';church.blur();updateBalance();clearMsg()},0));form.addEventListener('submit',async e=>{e.preventDefault();const button=form.querySelector('.save');button.disabled=true;button.textContent='Salvando...';clearMsg();try{const selected=church.options[church.selectedIndex],reportFiles=[...documents.files,...selectedDocumentPhotos];if(!reportFiles.length)throw new Error('Anexe uma imagem ou tire uma foto para salvar o relatório.');if(reportFiles.length>1)throw new Error('Envie apenas uma imagem por relatório.');const payload={report_date:'${windowState.reportDate}',church_id:church.value,church:selected?.dataset.name||'',responsible:form.responsible.value.trim(),members:Number(form.members.value),income:number(income.value),expenses:number(expenses.value),balance:updateBalance(),tithe:number(tithe.value),transferred:number(transferred.value)};const body=new FormData();body.append('report',JSON.stringify(payload));reportFiles.forEach(file=>body.append('documents',file));const response=await fetch('/financeiro/api/publico/relatorios',{method:'POST',body});const result=await response.json();if(!response.ok)throw new Error(result.error||'Não foi possível salvar o relatório.');form.reset();clearDocumentPhotos();churchTotvsFilter.value='';renderChurchOptions();church.value='';church.blur();updateBalance();message.textContent='Relatório enviado com sucesso.';message.className='message show'}catch(error){message.textContent=error.message;message.className='message error show'}finally{button.disabled=false;button.textContent='Salvar relatório'}});updateBalance();loadChurches();
  </script></body></html>`;
}
__name(publicFinancialReportPage, "publicFinancialReportPage");
async function listPublicReportChurches(env) {
  if (!publicReportsWindow().open) return json({ error: "O link público abre todo mês do dia 1 ao dia 8." }, 403);
  const churches = (await env.DB.prepare("SELECT id, name, totvs_code FROM churches ORDER BY name COLLATE NOCASE").all()).results || [];
  return json(churches);
}
__name(listPublicReportChurches, "listPublicReportChurches");
async function savePublicFinancialReport(request, env) {
  const windowState = publicReportsWindow();
  if (!windowState.open) return json({ error: "O link público abre todo mês do dia 1 ao dia 8." }, 403);
  let formData;
  try {
    formData = await request.formData();
  } catch {
    return json({ error: "Envio inválido. Preencha o relatório e anexe os documentos novamente." }, 400);
  }
  let report;
  try {
    report = JSON.parse(String(formData.get("report") || "{}"));
  } catch {
    return json({ error: "Dados do relatório inválidos." }, 400);
  }
  const churchId = String(report.church_id || "").trim();
  const church = churchId ? await env.DB.prepare("SELECT id, name FROM churches WHERE id = ?").bind(churchId).first() : null;
  if (!church) return json({ error: "Selecione uma igreja válida." }, 400);
  const duplicate = await env.DB.prepare(`SELECT id FROM financial_reports WHERE church_id = ? AND substr(report_date, 7, 4) || '-' || substr(report_date, 4, 2) = ? LIMIT 1`).bind(churchId, windowState.month).first();
  if (duplicate) return json({ error: "Já existe um relatório enviado para esta igreja neste mês. Procure a administração para corrigir." }, 409);
  const forwarded = new FormData();
  forwarded.append("report", JSON.stringify({ ...report, church_id: church.id, church: church.name, report_date: windowState.reportDate }));
  for (const file of formData.getAll("documents")) forwarded.append("documents", file);
  return saveReport(new Request("https://internal/financeiro/api/relatorios", { method: "POST", body: forwarded }), env);
}
__name(savePublicFinancialReport, "savePublicFinancialReport");

const PUBLIC_CHURCH_REGISTRATION_END = Date.parse("2026-09-19T00:00:00-04:00");
function publicChurchRegistrationOpen() {
  return Date.now() < PUBLIC_CHURCH_REGISTRATION_END;
}
...
function publicChurchRegistrationPage() {
  ...
  *{box-sizing:border-box}body{margin:0;font-family:Arial,sans-serif;background:#f0f7f2;color:#243b2e}.wrap{width:min(760px,calc(100% - 24px));margin:24px auto}.head{text-align:center;margin-bottom:18px}.head h1{color:#14532d;margin-bottom:6px}.card{background:#fff;border:1px solid #d5e5d9;border-radius:14px;box-shadow:0 8px 24px #14532d14;padding:24px}.deadline{background:#fff8df;border:1px solid #d7a92e;border-radius:8px;padding:12px;text-align:center;margin-bottom:20px;color:#6f5100}.grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.full{grid-column:1/-1}label{display:block;font-size:.86rem;font-weight:700;margin-bottom:7px}input,select{width:100%;height:46px;border:1px solid #c8dacd;border-radius:8px;padding:0 12px;font-size:1rem}button,.next-link{width:100%;margin-top:22px;border:0;border-radius:8px;padding:13px;background:#14532d;color:#fff;font-weight:800;font-size:1rem;cursor:pointer;text-align:center;text-decoration:none;display:block}.next-link{margin-top:12px;background:#0f6b3b}.message{margin-top:15px;padding:12px;border-radius:8px;display:none}.message.ok{display:block;background:#eaf7f1;color:#086347}.message.error{display:block;background:#fff0f0;color:#a91f2c}.hp{position:absolute;left:-9999px}@media(max-width:650px){.grid{grid-template-columns:1fr}.full{grid-column:auto}.card{padding:18px}}</style></head><body><main class="wrap"><header class="head"><h1>Cadastro de Igrejas</h1><p>Igreja Pentecostal Deus é Amor</p></header><section class="card"><div class="deadline">Prazo final: 18/09/2026<br><strong id="countdown">Calculando...</strong></div><form id="form"><div class="hp"><label>Não preencher<input name="website" tabindex="-1" autocomplete="off"></label></div><div class="grid">
  ...
  <div><label>Classificação*<select name="classification" required><option value="">Selecione</option><option>Local</option><option>Setorial</option><option>Estadual</option><option>Regional</option><option>Central</option></select></label></div>
  <div class="full"><label>Pertence a qual igreja?*</label><input id="parent-filter" type="search" autocomplete="off" placeholder="Filtrar por nome ou TOTVS" style="margin-bottom:8px;background:#f7fcf8"><select name="parent_church_id" id="parent" required><option value="">Carregando igrejas...</option></select></div>
  <div><label>Estado<select name="state"><option value="">Selecione</option><option value="AM">Amazonas</option><option value="AC">Acre</option><option value="PA">Pará</option><option value="RO">Rondônia</option><option value="RR">Roraima</option><option value="AP">Amapá</option><option value="TO">Tocantins</option></select></label></div>
  <div><label>Cidade<input name="city"></label></div>
  ...
  </div><button type="submit">Cadastrar igreja</button><div id="message" class="message" role="status"></div><div id="next-actions" hidden><a class="next-link" id="member-link" href="#">Cadastrar membro desta igreja</a></div></form></section></main><script>
  const end=Date.parse('2026-09-19T00:00:00-04:00'),form=document.querySelector('#form'),message=document.querySelector('#message'),nextActions=document.querySelector('#next-actions'),memberLink=document.querySelector('#member-link'),parent=document.querySelector('#parent'),parentFilter=document.querySelector('#parent-filter'),classification=form.classification;let publicChurches=[];
  ...
  function esc(s){return String(s||'').replace(/[&<>"]/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;'}[m]))}function renderParentOptions(){const current=parent.value,filter=String(parentFilter.value||'').trim().toLowerCase(),items=publicChurches.filter(c=>!filter||String(c.name||'').toLowerCase().includes(filter)||String(c.classification||'').toLowerCase().includes(filter)||String(c.totvs_code||'').toLowerCase().includes(filter));parent.innerHTML='<option value="">'+(filter&&!items.length?'Nenhuma igreja encontrada':'Selecione')+'</option>'+items.map(c=>'<option value="'+esc(c.id)+'">'+esc(c.name)+(c.totvs_code?' | TOTVS '+esc(c.totvs_code):'')+' - '+esc(c.classification)+'</option>').join('');if([...parent.options].some(option=>option.value===current))parent.value=current;updateParent()}async function loadChurches(){const response=await fetch('/financeiro/api/publico/igrejas');publicChurches=await response.json();renderParentOptions()}function updateParent(){const estadual=classification.value==='Estadual';parent.disabled=estadual;parentFilter.disabled=estadual;parent.required=!estadual;if(estadual){parent.value='';parentFilter.value=''}}classification.addEventListener('change',updateParent);parentFilter.addEventListener('input',renderParentOptions);loadChurches();
  form.addEventListener('submit',async e=>{e.preventDefault();const button=form.querySelector('button');button.disabled=true;message.className='message';nextActions.hidden=true;try{const data=Object.fromEntries(new FormData(form).entries());const response=await fetch('/financeiro/api/publico/solicitar-igreja',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify(data)});const result=await response.json();if(!response.ok)throw new Error(result.error||'Nao foi possivel enviar.');form.reset();updateParent();memberLink.href='/financeiro/cadastro-igrejas?membros=1&igreja='+encodeURIComponent(result.id||'');nextActions.hidden=false;message.textContent='Igreja cadastrada com sucesso. Agora voce pode cadastrar membro para esta igreja.';message.className='message ok'}catch(error){message.textContent=error.message;message.className='message error'}finally{button.disabled=false}});
</script></body></html>`;
}
__name(publicChurchRegistrationPage, "publicChurchRegistrationPage");
function publicMemberRegistrationPage(churchId = "") {
  const selectedChurchId = String(churchId || "").replace(/[^\w-]/g, "");
  if (!publicChurchRegistrationOpen()) return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>Cadastro encerrado</title><style>body{font-family:Arial;background:#f0f7f2;color:#243b2e;display:grid;place-items:center;min-height:100vh;margin:0}.card{background:#fff;padding:32px;border-radius:12px;border:1px solid #d5e5d9;text-align:center;max-width:520px}</style></head><body><main class="card"><h1>Prazo encerrado</h1><p>O periodo para cadastro terminou em 18/09/2026.</p></main></body></html>`;
  return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>Cadastro de Membros | IPDA</title><style>
  *{box-sizing:border-box}body{margin:0;font-family:Arial,sans-serif;background:#f0f7f2;color:#243b2e}.wrap{width:min(760px,calc(100% - 24px));margin:24px auto}.head{text-align:center;margin-bottom:18px}.head h1{color:#14532d;margin-bottom:6px}.card{background:#fff;border:1px solid #d5e5d9;border-radius:14px;box-shadow:0 8px 24px #14532d14;padding:24px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.full{grid-column:1/-1}label{display:block;font-size:.86rem;font-weight:700;margin-bottom:7px}input,select{width:100%;height:46px;border:1px solid #c8dacd;border-radius:8px;padding:0 12px;font-size:1rem;background:#fff}.checks{display:flex;gap:12px;flex-wrap:wrap}.checks label{display:flex;align-items:center;gap:8px;border:1px solid #c8dacd;border-radius:8px;padding:10px 12px;background:#f4fbf6}.checks input{width:18px;height:18px}.photo-input{position:absolute;width:1px;height:1px;opacity:0;pointer-events:none}.photo-actions{display:flex;gap:10px;flex-wrap:wrap;align-items:center}.photo-button{display:inline-block;border-radius:8px;background:#14532d;color:#fff;padding:12px 14px;font-weight:800;cursor:pointer}.photo-button.upload{background:#fff;color:#14532d;border:1px solid #c8dacd}.photo-name{color:#607567;font-size:.82rem}.hint{display:block;color:#607567;font-size:.76rem;margin-top:6px}button{width:100%;margin-top:22px;border:0;border-radius:8px;padding:13px;background:#14532d;color:#fff;font-weight:800;font-size:1rem;cursor:pointer}.message{margin-top:15px;padding:12px;border-radius:8px;display:none}.message.ok{display:block;background:#eaf7f1;color:#086347}.message.error{display:block;background:#fff0f0;color:#a91f2c}.hp{position:absolute;left:-9999px}@media(max-width:650px){.grid{grid-template-columns:1fr}.full{grid-column:auto}.card{padding:18px}}</style></head><body><main class="wrap"><header class="head"><h1>Cadastro de Membros</h1><p>Igreja Pentecostal Deus &eacute; Amor</p></header><section class="card"><form id="form"><div class="hp"><label>Nao preencher<input name="website" tabindex="-1" autocomplete="off"></label></div><div class="grid">
  <div class="full"><label>Igreja*<select name="church_id" id="church" required><option value="">Carregando igrejas...</option></select></label></div>
  <div class="full"><label>Nome completo*<input name="full_name" autocomplete="name" required></label></div>
  <div><label>CPF<input name="cpf" id="cpf" inputmode="numeric" autocomplete="off"></label></div>
  <div><label>Telefone<input name="phone" autocomplete="tel" inputmode="tel"></label></div>
  <div><label>Nascimento<input name="birth_date" type="date"></label></div>
  <div><label>Funcao ministerial*<select name="ministry_role" required><option value="">Selecione</option><option>Cooperador</option><option>Obreiro</option><option value="Di&#225;cono">Diacono</option><option>Membro</option><option value="Presb&#237;tero">Presbitero</option><option>Pastor</option></select></label></div>
  <div class="full"><label>Responsabilidade</label><div class="checks"><label><input name="is_leader" type="checkbox" value="1"> Dirigente</label><label><input name="is_financial" type="checkbox" value="1"> Financeiro</label></div></div>
  <div class="full"><label>Foto do membro</label><div class="photo-actions"><input class="photo-input" id="photo-camera" type="file" accept="image/jpeg,image/png,image/webp" capture="environment"><input class="photo-input" id="photo-upload" type="file" accept="image/jpeg,image/png,image/webp"><label class="photo-button" for="photo-camera">Tirar foto</label><label class="photo-button upload" for="photo-upload">Enviar foto</label><span class="photo-name" id="photo-name">Nenhuma foto selecionada</span></div><small class="hint">JPG, PNG ou WEBP de ate 5 MB.</small></div>
  </div><button type="submit">Cadastrar membro</button><div id="message" class="message" role="status"></div></form></section></main><script>
  const selectedChurch='${selectedChurchId}',form=document.querySelector('#form'),church=document.querySelector('#church'),message=document.querySelector('#message'),photoCamera=document.querySelector('#photo-camera'),photoUpload=document.querySelector('#photo-upload'),photoName=document.querySelector('#photo-name');let selectedPhoto=null;
  function setPhoto(file){selectedPhoto=file||null;photoName.textContent=file?(file.name||'Foto capturada'):'Nenhuma foto selecionada'}photoCamera.addEventListener('change',()=>{photoUpload.value='';setPhoto(photoCamera.files[0])});photoUpload.addEventListener('change',()=>{photoCamera.value='';setPhoto(photoUpload.files[0])});
  document.querySelector('#cpf').addEventListener('input',e=>{const d=e.target.value.replace(/\\D/g,'').slice(0,11);e.target.value=d.replace(/^(\\d{3})(\\d)/,'$1.$2').replace(/^(\\d{3})\\.(\\d{3})(\\d)/,'$1.$2.$3').replace(/\\.(\\d{3})(\\d)/,'.$1-$2')});
  function esc(s){return String(s||'').replace(/[&<>"]/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;'}[m]))}async function loadChurches(){try{const response=await fetch('/financeiro/api/publico/igrejas');const data=await response.json();if(!response.ok)throw new Error(data.error||'Nao foi possivel carregar as igrejas.');church.innerHTML='<option value="">Selecione</option>'+data.map(c=>'<option value="'+esc(c.id)+'">'+esc(c.name)+' - '+esc(c.classification)+'</option>').join('');if(selectedChurch)church.value=selectedChurch}catch(error){church.innerHTML='<option value="">Link indisponivel</option>';message.textContent=error.message;message.className='message error'}}
  form.addEventListener('submit',async e=>{e.preventDefault();const button=form.querySelector('button');button.disabled=true;message.className='message';try{const data=Object.fromEntries(new FormData(form).entries());data.status='Ativo';const body=new FormData();body.append('member',JSON.stringify(data));body.append('website',data.website||'');if(selectedPhoto)body.append('photo',selectedPhoto);const response=await fetch('/financeiro/api/publico/membros',{method:'POST',body});const result=await response.json();if(!response.ok)throw new Error(result.error||'Nao foi possivel salvar o membro.');const currentChurch=church.value;form.reset();church.value=currentChurch;setPhoto(null);message.textContent='Membro cadastrado com sucesso.';message.className='message ok'}catch(error){message.textContent=error.message;message.className='message error'}finally{button.disabled=false}});loadChurches();
  </script></body></html>`;
}
__name(publicMemberRegistrationPage, "publicMemberRegistrationPage");
async function savePublicMember(request, env) {
  if (!publicChurchRegistrationOpen()) return json({ error: "O prazo para cadastro terminou em 18/09/2026." }, 403);
  let formData;
  try {
    formData = await request.formData();
  } catch {
    return json({ error: "Dados do membro invalidos." }, 400);
  }
  if (String(formData.get("website") || "").trim()) return json({ ok: true }, 201);
  let member;
  try {
    member = JSON.parse(String(formData.get("member") || "{}"));
  } catch {
    return json({ error: "Dados do membro invalidos." }, 400);
  }
  const forwarded = new FormData();
  forwarded.append("member", JSON.stringify({ ...member, status: "Ativo" }));
  const photo = formData.get("photo");
  if (photo && typeof photo !== "string" && photo.size > 0) forwarded.append("photo", photo);
  return saveMember(new Request("https://internal/financeiro/api/membros", { method: "POST", body: forwarded }), env);
}
__name(savePublicMember, "savePublicMember");
async function submitPublicChurchRequest(request, env) {
  ...
  const name=clean(data.name),classification=clean(data.classification),address=clean(data.address),parentId=clean(data.parent_church_id);
  if (!name||!classification||!address) return json({ error: "Informe nome, classificação e endereço." }, 400);
  if (!new Set(["Local","Setorial","Estadual","Regional","Central"]).has(classification)) return json({ error: "Classificação inválida." }, 400);
  if (classification!=="Estadual") {
    const parent=await env.DB.prepare("SELECT id FROM churches WHERE id = ?").bind(parentId).first();
    if (!parent) return json({ error: "Selecione a igreja à qual esta unidade pertence." }, 400);
  }
  ...
  const saved=await result.clone().json().catch(()=>({}));
  ...
  return json({ ok:true, id:saved.id, name },201);
}
...
async function reviewPublicChurchRequest(id, action, env, user) {
  await ensurePublicChurchRequestsTable(env);
  const item=await env.DB.prepare("SELECT * FROM public_church_requests WHERE id=? AND status='pending'").bind(id).first();
  if(!item)return json({error:"Solicitação não encontrada."},404);
  if(action==="reject"){await env.DB.prepare("UPDATE public_church_requests SET status='rejected',reviewed_at=CURRENT_TIMESTAMP,reviewed_by=? WHERE id=?").bind(user.login,id).run();return json({ok:true});}
  const internalRequest=new Request("https://internal/financeiro/api/igrejas",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(item)});
  const result=await saveChurch(internalRequest,env);
  if(!result.ok)return result;
  await env.DB.prepare("UPDATE public_church_requests SET status='approved',reviewed_at=CURRENT_TIMESTAMP,reviewed_by=? WHERE id=?").bind(user.login,id).run();
  return json({ok:true});
}
__name(reviewPublicChurchRequest, "reviewPublicChurchRequest");
...
async function saveReport(request, env, reportId = '') {
  ...
  if (!reportId && !files.length) return json({ error: "Anexe uma imagem para salvar o relat\xF3rio." }, 400);
  if (files.length > 1) return json({ error: "Envie apenas uma imagem por relat\xF3rio." }, 400);
  if (files.some((file) => file.size > 10 * 1024 * 1024)) return json({ error: "A imagem pode ter no m\xE1ximo 10 MB." }, 400);
  const accepted = /* @__PURE__ */ new Set(["image/jpeg", "image/png", "image/webp"]);
  if (files.some((file) => !accepted.has(file.type))) return json({ error: "Use somente imagem JPG, PNG ou WEBP." }, 400);
  ...
  const stored = [];
  try {
    const oldDocuments = existing && files.length ? (await env.DB.prepare("SELECT r2_key FROM financial_documents WHERE report_id = ?").bind(reportId).all()).results || [] : [];
    ...
    if (existing && stored.length) statements.push(env.DB.prepare("DELETE FROM financial_documents WHERE report_id = ?").bind(reportId));
    ...
    if (oldDocuments.length) await Promise.allSettled(oldDocuments.map((document) => env.DOCUMENTS.delete(document.r2_key)));
...
var worker_default = {
  async fetch(request, env) {
    ...
    if (url.pathname === "/financeiro/cadastro-igrejas" && request.method === "GET") {
      const html = url.searchParams.get("membros") === "1" ? publicMemberRegistrationPage(url.searchParams.get("igreja") || "") : publicChurchRegistrationPage();
    ...
    if (url.pathname === "/financeiro/cadastro-membros" && request.method === "GET") {
      return new Response(publicMemberRegistrationPage(url.searchParams.get("igreja") || ""), { headers: { "content-type": "text/html; charset=UTF-8", "cache-control": "no-store", "x-content-type-options": "nosniff" } });
    }
    if (url.pathname === "/financeiro/relatorio-publico" && request.method === "GET") {
      return new Response(publicFinancialReportPage(), { headers: { "content-type": "text/html; charset=UTF-8", "cache-control": "no-store", "x-content-type-options": "nosniff" } });
    }
    if (url.pathname === "/financeiro/api/publico/igrejas" && request.method === "GET") {
      if (!publicChurchRegistrationOpen()) return json({ error: "Prazo encerrado." }, 403);
      const churches = await listChurches(env);
      return json(churches.map(({ id, name, classification, totvs_code }) => ({ id, name, classification, totvs_code })));
    }
    if (url.pathname === "/financeiro/api/publico/solicitar-igreja" && request.method === "POST") return submitPublicChurchRequest(request, env);
    if (url.pathname === "/financeiro/api/publico/membros" && request.method === "POST") return savePublicMember(request, env);
    if (url.pathname === "/financeiro/api/publico/relatorio/igrejas" && request.method === "GET") return listPublicReportChurches(env);
    if (url.pathname === "/financeiro/api/publico/relatorios" && request.method === "POST") return savePublicFinancialReport(request, env);
    ...
    if (url.pathname === "/financeiro/api/solicitacoes-igrejas" && request.method === "GET") {
      const auth = await authorize(request, env, ["admin"]);
      return auth.response || json(await listPublicChurchRequests(env));
    }
    const publicChurchActionMatch = url.pathname.match(/^\/financeiro\/api\/solicitacoes-igrejas\/([^/]+)\/(approve|reject)$/);
    if (publicChurchActionMatch && request.method === "POST") {
      const auth = await authorize(request, env, ["admin"]);
      return auth.response || reviewPublicChurchRequest(decodeURIComponent(publicChurchActionMatch[1]), publicChurchActionMatch[2], env, auth.user);
    }
    ...
    if (url.pathname === "/financeiro/api/evolucao" && request.method === "GET") {
      const auth = await authorize(request, env, ["admin", "agent"]);
      if (auth.response) return auth.response;
      const data = await evolutionData({
        churchId: url.searchParams.get("church_id") || "",
        parentChurchId: url.searchParams.get("parent_church_id") || "",
        classification: url.searchParams.get("classification") || ""
      }, env);
      return data ? json(data) : json({ error: "Igreja n\xE3o encontrada." }, 404);
    }
