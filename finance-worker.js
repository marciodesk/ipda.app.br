...
function dashboardCsv(data) {
  ...
  const headers = ["M\xEAs de refer\xEAncia", "Igreja", "TOTVS", "Classifica\xE7\xE3o", "Cidade", "Estado", "Situa\xE7\xE3o", "Entradas", "Sa\xEDdas", "Saldo", "D\xEDzimo informativo", "Transfer\xEAncia para o pr\xF3ximo m\xEAs", "\xDAltimo envio"];
